...
But I am 17 — and I walk on the same broken road that has been broken for **seven years.** I study under the same flickering tubelight. I know families whose ration cards were rejected for reasons no one explains.

I have not governed. But I have **lived under governance.** Every single day.
...
We don't need more mock parliaments, friends.

We need a real chair. In a real room. With a real vote.

And if they won't give it —

**We'll build the room ourselves.**
...
## Delivery Cheat Sheet (Memorize This)
...
| *"colonialism"* | Don't shout it. State it. Like a fact in an exam. That's what makes it devastating. |
| Last 3 lines | Each line = one breath. Pause between them. Voice drops. No smile. You are not performing anymore. You are **declaring.** |

---

## What Got Cut (and Why)

Everything that was *good but not lethal* was removed:

- ❌ The "three policy proposals" section — too specific, eats time, this is extempore not a policy paper
- ❌ "Don't give us words and ask us to be quiet" — beautiful line but the "future/present" flip does the same job faster
- ❌ Mock parliament extended metaphor — compressed to two lines at the end
- ❌ Army at 17 / vote at 18 comparison — strong point but sacrificed for time
- ❌ The address to teachers at the end — the colonialism line already does this work

**What survived:** Only the lines that make people **stop breathing for a second.** Everything else is scaffolding to get to those lines.
...
3. **"We'll build the room ourselves."** → This is not hope. This is not a request. This is the quiet sound of someone who has stopped asking for permission. It is the most unsettling thing a 16-year-old can say to a room full of adults. **Because they believe it.**
