# Chapter 2: Electrochemical Cells (Galvanic Cells)
...
### Harnessing Chemical Chaos
If you drop a zinc rod directly into a beaker of copper sulphate ($CuSO_4$), a spontaneous redox reaction occurs. Zinc dissolves, copper deposits on the rod, and the beaker gets very hot. The energy of the reaction is wasted as heat because the electrons are transferred *directly* from zinc atoms to copper ions at the surface of the rod.

To harness this energy as electricity, we must **separate the reactants into two different beakers (half-cells)** and force the electrons to travel through a wire to get from Zinc to Copper. This setup is called a **Galvanic (or Voltaic) Cell**. The most famous example is the **Daniell Cell**.

### The Engine and the Bridge
- **The Engine (The Wire):** Electrons travel from the Zinc beaker (where they are released via oxidation) through a wire to the Copper beaker (where they are consumed via reduction). This flow lights up a bulb.
- **The Bridge (The Salt Bridge):** As electrons leave the zinc beaker, positive $Zn^{2+}$ ions build up. As electrons arrive in the copper beaker, positive $Cu^{2+}$ ions are consumed, leaving behind excess negative $SO_4^{2-}$ ions. This charge imbalance would instantly stop the flow of electrons. The **Salt Bridge** (an inverted U-tube filled with an inert electrolyte like $KCl$) acts as a balancer. It drops negative $Cl^-$ ions into the zinc beaker and positive $K^+$ ions into the copper beaker to maintain electrical neutrality, keeping the engine running.

---

## 🔬 Stage 2: The Formula Lab

There are no massive mathematical formulas here, but there is a strict **grammar** for how we write and interpret cells.

### 1. The L-O-A-N Rule
Always remember what happens on the left side of a standard Galvanic cell diagram:
- **L**eft
- **O**xidation
- **A**node
- **N**egative terminal

By default, the right side is the Cathode, where Reduction happens, and it is the Positive terminal.

### 2. Cell Notation (The Shorthand)
Scientists don't draw beakers every time. They use a standard notation:
$$ Anode\ (s) \ | \ Anode\ Ion\ (aq) \ || \ Cathode\ Ion\ (aq) \ | \ Cathode\ (s) $$
- **Single Vertical Line ($|$):** Represents a phase boundary (e.g., solid metal in contact with aqueous solution).
- **Double Vertical Line ($||$):** Represents the salt bridge connecting the two half-cells.
- *Rule of thumb:* It goes from **Solid $\rightarrow$ Aqueous $\rightarrow$ Aqueous $\rightarrow$ Solid**. (A-B-C: Anode, Bridge, Cathode).

---

## 🧱 Stage 3: Type-wise Mastery

### Type 1: Identifying L-O-A-N Properties ⭐

**Pattern:** "Given a cell setup, identify the anode, cathode, signs, and location of oxidation/reduction."

**Solved Example** 🟢
> A Galvanic cell is constructed using Mg and Ag electrodes. Mg is more reactive. Identify the Anode, its sign, and the process occurring there.

<details><summary><b>Solution</b></summary>
Since Mg is more reactive, it will lose electrons (Oxidation). 
According to L-O-A-N: Oxidation occurs at the **Anode**, which has a **Negative** sign.
Therefore, Mg is the Anode, it is the negative terminal, and oxidation occurs there.
</details>
...
### Type 2: Writing Cell Notation from Overall Reaction ⭐

**Pattern:** "Given an overall balanced redox equation, write the IUPAC standard cell notation."

**Solved Example** 🟡
> Write the cell notation for: $Zn(s) + Cu^{2+}(aq) \rightarrow Zn^{2+}(aq) + Cu(s)$

<details><summary><b>Solution</b></summary>
- Identify Oxidation (Anode): $Zn(s) \rightarrow Zn^{2+}(aq)$. This goes on the left.
- Identify Reduction (Cathode): $Cu^{2+}(aq) \rightarrow Cu(s)$. This goes on the right.
- Separate them with a salt bridge ($||$).
**Notation:** $Zn(s) \ | \ Zn^{2+}(aq) \ || \ Cu^{2+}(aq) \ | \ Cu(s)$
</details>

**Practice:**

1. 🟢 Write the cell notation for: $Mg(s) + 2Ag^+(aq) \rightarrow Mg^{2+}(aq) + 2Ag(s)$
<details><summary><b>Answer</b></summary>
$Mg(s) \ | \ Mg^{2+}(aq) \ || \ Ag^+(aq) \ | \ Ag(s)$
*(Note: Stoichiometric coefficients like '2' are generally NOT included in the standard cell notation).*
</details>

2. 🟢 Write the cell notation for: $Fe(s) + Cu^{2+}(aq) \rightarrow Fe^{2+}(aq) + Cu(s)$
<details><summary><b>Answer</b></summary>
$Fe(s) \ | \ Fe^{2+}(aq) \ || \ Cu^{2+}(aq) \ | \ Cu(s)$
</details>

3. 🟡 Write the cell notation for: $2Al(s) + 3Pb^{2+}(aq) \rightarrow 2Al^{3+}(aq) + 3Pb(s)$
<details><summary><b>Answer</b></summary>
$Al(s) \ | \ Al^{3+}(aq) \ || \ Pb^{2+}(aq) \ | \ Pb(s)$
</details>

4. 🟡 Write the cell notation for: $Ni(s) + Sn^{2+}(aq) \rightarrow Ni^{2+}(aq) + Sn(s)$. Assume concentrations are 1M.
<details><summary><b>Answer</b></summary>
...
Since $H_2$ is a gas, it needs an inert solid conductor like Platinum (Pt) to transfer electrons.
**Notation:** $Cu(s) \ | \ Cu^{2+}(aq) \ || \ H^+(aq) \ | \ H_2(g) \ | \ Pt(s)$
</details>

---

### Type 3: Writing Overall Reaction from Cell Notation ⭐

**Pattern:** "Given a cell notation, write the balanced overall chemical reaction."

**Solved Example** 🟡
> Write the overall reaction for: $Al(s) \ | \ Al^{3+}(aq) \ || \ Ni^{2+}(aq) \ | \ Ni(s)$

<details><summary><b>Solution</b></summary>
- Anode (Left): $Al \rightarrow Al^{3+} + 3e^-$ (Oxidation)
- Cathode (Right): $Ni^{2+} + 2e^- \rightarrow Ni$ (Reduction)
- Balance electrons: Multiply Anode by 2 and Cathode by 3.
  $2Al \rightarrow 2Al^{3+} + 6e^-$
  $3Ni^{2+} + 6e^- \rightarrow 3Ni$
- **Overall:** $2Al(s) + 3Ni^{2+}(aq) \rightarrow 2Al^{3+}(aq) + 3Ni(s)$
</details>

**Practice:**

1. 🟢 Write the overall reaction for: $Zn(s) \ | \ Zn^{2+}(aq) \ || \ Ag^+(aq) \ | \ Ag(s)$
<details><summary><b>Answer</b></summary>
Oxidation: $Zn \rightarrow Zn^{2+} + 2e^-$
Reduction: $Ag^+ + e^- \rightarrow Ag$ (Multiply by 2)
**Overall:** $Zn(s) + 2Ag^+(aq) \rightarrow Zn^{2+}(aq) + 2Ag(s)$
</details>

2. 🟢 Write the overall reaction for: $Pb(s) \ | \ Pb^{2+}(aq) \ || \ Cu^{2+}(aq) \ | \ Cu(s)$
<details><summary><b>Answer</b></summary>
**Overall:** $Pb(s) + Cu^{2+}(aq) \rightarrow Pb^{2+}(aq) + Cu(s)$
</details>

3. 🟡 Write the overall reaction for: $Mg(s) \ | \ Mg^{2+}(aq) \ || \ Al^{3+}(aq) \ | \ Al(s)$
<details><summary><b>Answer</b></summary>
Oxidation: $Mg \rightarrow Mg^{2+} + 2e^-$ (Multiply by 3)
Reduction: $Al^{3+} + 3e^- \rightarrow Al$ (Multiply by 2)
**Overall:** $3Mg(s) + 2Al^{3+}(aq) \rightarrow 3Mg^{2+}(aq) + 2Al(s)$
</details>

4. 🟡 Write the overall reaction for: $Cd(s) \ | \ Cd^{2+}(aq) \ || \ H^+(aq) \ | \ H_2(g) \ | \ Pt(s)$
<details><summary><b>Answer</b></summary>
Oxidation: $Cd \rightarrow Cd^{2+} + 2e^-$
Reduction: $2H^+ + 2e^- \rightarrow H_2$
**Overall:** $Cd(s) + 2H^+(aq) \rightarrow Cd^{2+}(aq) + H_2(g)$
</details>

5. 🔴 Write the overall reaction for: $Pt(s) \ | \ Fe^{2+}(aq), Fe^{3+}(aq) \ || \ Ag^+(aq) \ | \ Ag(s)$
<details><summary><b>Answer</b></summary>
Left side (Oxidation of Fe2+ to Fe3+): $Fe^{2+} \rightarrow Fe^{3+} + e^-$
Right side (Reduction of Ag+): $Ag^+ + e^- \rightarrow Ag$
**Overall:** $Fe^{2+}(aq) + Ag^+(aq) \rightarrow Fe^{3+}(aq) + Ag(s)$
</details>
...
- The cell reverses its operation and becomes an **Electrolytic Cell**.
- Electrons now flow from **Cu to Zn** in the external circuit.
- The reaction reverses: **$Zn^{2+} + Cu \rightarrow Zn + Cu^{2+}$**. Zinc deposits, Copper dissolves.
</details>
...
5. 🔴 An external potential $E_{ext}$ opposing a Galvanic cell is slowly increased from 0 to a value much higher than $E_{cell}$. Describe the changes in electron flow.
<details><summary><b>Answer</b></summary>
- Initially ($E_{ext} < E_{cell}$): Electrons flow from the cell's anode to cathode.
- At $E_{ext} = E_{cell}$: Electron flow stops completely.
- Finally ($E_{ext} > E_{cell}$): Electron flow reverses direction, flowing from the cell's original cathode to the original anode.
</details>
...
- Ag is the Cathode. It undergoes reduction: $Ag^+ + e^- \rightarrow Ag$. Aqueous $Ag^+$ ions are turning into solid silver, so the **concentration of $Ag^+$ ions decreases**.
</details>
...
- It cannot be used with $Ag^+$ or $Pb^{2+}$ because $Cl^-$ will react with them to form insoluble precipitates ($AgCl$ or $PbCl_2$), clogging the salt bridge and stopping the cell.
</details>
...
### Type 7: Inert Electrodes and Gas/Ion Cells Notation ⭐

**Pattern:** "How to write notations or reactions for cells involving gases or ions in two different oxidation states."

**Solved Example** 🔴
> Write the cell notation for a cell where $H_2$ gas is oxidized to $H^+$, and $Fe^{3+}$ is reduced to $Fe^{2+}$.

<details><summary><b>Solution</b></summary>
- Anode: $H_2(g) \rightarrow 2H^+(aq) + 2e^-$. Requires inert Pt electrode.
  Notation: $Pt(s) \ | \ H_2(g) \ | \ H^+(aq)$
- Cathode: $Fe^{3+}(aq) + e^- \rightarrow Fe^{2+}(aq)$. Both are aqueous, so no solid metal is present. Requires inert Pt electrode to transfer electrons.
  Notation: $Fe^{3+}(aq), Fe^{2+}(aq) \ | \ Pt(s)$
- **Full Notation:** $Pt(s) \ | \ H_2(g) \ | \ H^+(aq) \ || \ Fe^{3+}(aq), Fe^{2+}(aq) \ | \ Pt(s)$
*(Notice the comma separating two ions in the same phase).*
</details>
...
2. 🟡 Write the cell notation for the oxidation of $Cl^-$ to $Cl_2$ gas, coupled with the reduction of $Ag^+$ to $Ag(s)$.
<details><summary><b>Answer</b></summary>
Anode requires Pt. $Pt(s) \ | \ Cl_2(g) \ | \ Cl^-(aq) \ || \ Ag^+(aq) \ | \ Ag(s)$
</details>

3. 🔴 A half-cell contains $MnO_4^-$ and $Mn^{2+}$ in acidic medium ($H^+$). Write its notation if it acts as a cathode.
<details><summary><b>Answer</b></summary>
It requires an inert electrode like Pt.
$MnO_4^-(aq), H^+(aq), Mn^{2+}(aq) \ | \ Pt(s)$
</details>

4. 🔴 Identify the overall reaction for: $Pt(s) \ | \ Br^-(aq) \ | \ Br_2(l) \ || \ Cl_2(g) \ | \ Cl^-(aq) \ | \ Pt(s)$
<details><summary><b>Answer</b></summary>
Anode: $2Br^- \rightarrow Br_2 + 2e^-$
Cathode: $Cl_2 + 2e^- \rightarrow 2Cl^-$
...
**Q1. (NCERT Type)** 🟡 In a Galvanic cell, the electrical neutrality of the solutions is maintained by:
(a) The external wire
(b) The electrodes
(c) The salt bridge
(d) The battery
...
(d) It prevents the physical mixing of the two electrolytes.
...
<details><summary><b>Answer</b></summary>
**Answer: (c)**
Zn is the Anode (oxidation, $Zn \rightarrow Zn^{2+} + 2e^-$). The $Zn^{2+}$ concentration increases, making the beaker positive. To neutralize this, negative $Cl^-$ ions from the salt bridge migrate towards the Zinc electrode.
</details>

**Q4. (Subtle Detail)** 🟡 The Liquid Junction Potential (LJP) arises at the boundary of two miscible solutions because:
(a) Positive and negative ions diffuse at different rates across the boundary.
(b) Electrons jump across the boundary.
(c) The solutions have different temperatures.
(d) The electrodes have different standard potentials.

<details><summary><b>Answer</b></summary>
**Answer: (a)**
LJP is strictly caused by the difference in ionic mobilities (diffusion rates) of the cations and anions at the liquid-liquid interface.
</details>
...
Notation: **$Fe(s) \ | \ Fe^{2+}(aq) \ || \ Ag^+(aq) \ | \ Ag(s)$**
(b) Normally, Fe is the anode and dissolves (loses mass). If $E_{ext} > E_{cell}$, the cell acts as an electrolytic cell and the reaction reverses. Fe becomes the cathode (where reduction happens). Therefore, $Fe^{2+}$ will deposit onto the electrode, and its **mass will increase**.
</details>
...
Notation: **$Pt(s) \ | \ Sn^{2+}(aq), Sn^{4+}(aq) \ || \ Fe^{3+}(aq), Fe^{2+}(aq) \ | \ Pt(s)$**
(b) Since all active species are aqueous ions, **inert electrodes** (like Platinum or Graphite) must be used.
(c) $NO_3^-$ are anions. Anions always move towards the **Anode half-cell** (the Tin half-cell) to neutralize the newly formed positive charge (as $Sn^{2+}$ turns into more highly charged $Sn^{4+}$).
</details>
...
**Q2.** 🟡 Describe the function of a salt bridge in a Galvanic cell. *(2 marks)*
<details><summary><b>Model Answer</b></summary>
1. It completes the electrical circuit by allowing ions to flow from one half-cell to the other.
2. It maintains the electrical neutrality of the solutions in the two half-cells by providing oppositely charged ions, thereby preventing the cell from stopping due to charge accumulation.
</details>

**Q3.** 🟡 Represent the Galvanic cell in which the reaction $Zn(s) + Cu^{2+}(aq) \rightarrow Zn^{2+}(aq) + Cu(s)$ takes place. *(1 mark)*
<details><summary><b>Model Answer</b></summary>
$Zn(s) \ | \ Zn^{2+}(aq) \ || \ Cu^{2+}(aq) \ | \ Cu(s)$
</details>

**Q4.** 🟡 State two conditions for an electrolyte to be used in a salt bridge. *(2 marks)*
<details><summary><b>Model Answer</b></summary>
1. The mobility (or transport number) of the cation and anion must be nearly equal (e.g., $K^+$ and $Cl^-$).
...
(d) Decreasing the concentration of $Cl^-$.

<details><summary><b>Answer</b></summary>
**Answer: (b)**
Overall reaction: $H_2 + Cl_2 \rightarrow 2H^+ + 2Cl^-$.
...
(d) The electrons will start flowing through the salt bridge.

<details><summary><b>Answer</b></summary>
**Answer: (b)**
$Cl^-$ ions from the salt bridge will react with $Pb^{2+}$ ions to form insoluble $PbCl_2$ precipitate at the junction. This clogs the salt bridge, stops ion flow, and breaks the circuit, causing the voltage to drop to zero.
</details>

---

*Next: [Chapter 3 — Electrode Potential & Electrochemical Series →](./03_electrode_potential.md)*
