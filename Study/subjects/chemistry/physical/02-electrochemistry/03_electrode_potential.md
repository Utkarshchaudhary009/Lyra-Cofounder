...
**Solved Example** 🟢
> For zinc, the standard oxidation potential $E^\circ_{Zn/Zn^{2+}}$ is $+0.76\ V$. What is its standard reduction potential, and what is its IUPAC "Standard Electrode Potential"?<br>
...
1. 🟢 Given $E^\circ_{Cu^{2+}/Cu} = +0.34\ V$. What is the standard oxidation potential of Copper?<br>
...
3. 🟡 For a metal $M$, $E^\circ_{M/M^{3+}} = +1.66\ V$. What is the value of $E^\circ_{M^{3+}/M}$?<br>
<details><summary><b>Answer</b></summary>
The given notation $M/M^{3+}$ represents oxidation. The required notation $M^{3+}/M$ represents reduction. 
$E^\circ_{M^{3+}/M} = -1.66\ V$.
</details>

4. 🟡 A textbook states: "The standard oxidation potential of $Fe^{2+}$ to $Fe^{3+}$ is $-0.77\ V$." What is the standard electrode potential for the $Fe^{3+}/Fe^{2+}$ couple?<br>
<details><summary><b>Answer</b></summary>
...
5. 🔴 If the reduction potential of $I_2/I^-$ is $+0.54\ V$, what is the potential for the reaction $2I^- \rightarrow I_2 + 2e^-$?<br>
<details><summary><b>Answer</b></summary>
...
**Solved Example** 🟡
> Given $E^\circ_{A^{2+}/A} = -0.25\ V$ and $E^\circ_{B^{2+}/B} = +0.15\ V$. Which metal has a greater tendency to undergo oxidation?<br>
...
1. 🟢 Given $E^\circ_{X^+/X} = +0.80\ V$ and $E^\circ_{Y^{2+}/Y} = -0.76\ V$. Which ion has a greater tendency to gain electrons?<br>
<details><summary><b>Answer</b></summary>
...
2. 🟢 $E^\circ_{Zn^{2+}/Zn} = -0.76\ V$ and $E^\circ_{Cu^{2+}/Cu} = +0.34\ V$. Which metal prefers to lose electrons?<br>
<details><summary><b>Answer</b></summary>
...
4. 🟡 Given $E^\circ_{Mg^{2+}/Mg} = -2.37\ V$ and $E^\circ_{Ag^+/Ag} = +0.80\ V$. If you place Mg in a solution of $Ag^+$, will a spontaneous reaction occur?<br>
<details><summary><b>Answer</b></summary>
...
5. 🔴 If $E^\circ_{F_2/F^-} = +2.87\ V$ and $E^\circ_{Li^+/Li} = -3.05\ V$, which species is the strongest electron puller (oxidizing agent) and which is the strongest electron pusher (reducing agent)?<br>
<details><summary><b>Answer</b></summary>
...
**Solved Example** 🟢
> The standard reduction potential for $Cu^{2+} + 2e^- \rightarrow Cu$ is $+0.34\ V$. What is the standard potential for the half-reaction $\frac{1}{2} Cu^{2+} + e^- \rightarrow \frac{1}{2} Cu$?<br>
...
1. 🟢 $E^\circ$ for $Ag^+ + e^- \rightarrow Ag$ is $0.80\ V$. What is $E^\circ$ for $2Ag^+ + 2e^- \rightarrow 2Ag$?<br>
<details><summary><b>Answer</b></summary>
...
3. 🟡 Why is $\Delta G^\circ$ multiplied when a reaction is multiplied, but $E^\circ$ is not?<br>
<details><summary><b>Answer</b></summary>
...
4. 🟡 A student calculates the oxidation potential of $2Cl^- \rightarrow Cl_2 + 2e^-$ as $-1.36\ V$. What is the reduction potential of $\frac{1}{2} Cl_2 + e^- \rightarrow Cl^-$?<br>
<details><summary><b>Answer</b></summary>
...
5. 🔴 Given $E^\circ_{Fe^{3+}/Fe^{2+}} = 0.77\ V$. Is it correct to say the potential for the transfer of 2 electrons ($2Fe^{3+} + 2e^- \rightarrow 2Fe^{2+}$) is $1.54\ V$?<br>
<details><summary><b>Answer</b></summary>
...
**Solved Example** 🟢
> A scientist measures the potential of a Copper electrode dipped in a $0.1\ M$ $CuSO_4$ solution at 298 K. Can this value be called the Standard Electrode Potential ($E^\circ$)?<br>
...
1. 🟢 What are the standard conditions of temperature and pressure for measuring $E^\circ$?<br>
<details><summary><b>Answer</b></summary>
Temperature = **298 K** ($25^\circ C$). Pressure for gases = **1 bar** (or 1 atm).
</details>

2. 🟢 If you measure a Zinc half-cell at 300 K with a $1\ M$ solution, is it the standard potential?<br>
<details><summary><b>Answer</b></summary>
**No.** The temperature must be exactly 298 K.
</details>

3. 🟡 A chlorine gas electrode $Pt | Cl_2 | Cl^-$ has $Cl_2$ gas bubbling at 2 atm and $[Cl^-] = 1\ M$ at 298 K. Is this a standard half-cell?<br>
<details><summary><b>Answer</b></summary>
**No.** The gas pressure must be exactly 1 atm (or 1 bar). 
</details>

4. 🟡 For the half-cell $Pt | Fe^{2+}, Fe^{3+}$, what concentrations are required to make it a standard half-cell?<br>
<details><summary><b>Answer</b></summary>
**Both** $[Fe^{2+}]$ and $[Fe^{3+}]$ must be exactly $1\ M$.
</details>

5. 🔴 Why do we even need "Standard Conditions"?<br>
<details><summary><b>Answer</b></summary>
...
**Solved Example** 🟡
> If the solution pressure of a metal $M$ is greater than the osmotic pressure of its ions $M^{n+}$ in the solution, what will be the charge on the metal rod?<br>
...
1. 🟢 If the osmotic pressure of ions is greater than the solution pressure of the metal, what happens to the metal rod?<br>
<details><summary><b>Answer</b></summary>
...
2. 🟡 A metal rod is dipped in its salt solution and develops no potential difference. What does this imply about the two pressures?<br>
<details><summary><b>Answer</b></summary>
...
3. 🟡 Why does the dissolution of a metal into its own solution eventually stop if not connected to an external circuit?<br>
<details><summary><b>Answer</b></summary>
...
4. 🔴 At the interface of a positively charged electrode and the solution, what does the Helmholtz electrical double layer consist of?<br>
<details><summary><b>Answer</b></summary>
...
**Solved Example** 🟡
> The standard reduction potential of $Ni^{2+}/Ni$ is $-0.25\ V$. Does Nickel have a natural tendency to be oxidized or reduced when compared to Hydrogen (which has $E^\circ = 0.00\ V$)?<br>
...
1. 🟢 $E^\circ_{Cu^{2+}/Cu} = +0.34\ V$. Will Copper naturally oxidize or reduce compared to Hydrogen?<br>
<details><summary><b>Answer</b></summary>
...
2. 🟢 A metal has $E^\circ = -2.37\ V$. Is it a strong oxidizing agent or a strong reducing agent?<br>
<details><summary><b>Answer</b></summary>
...
4. 🟡 A non-metal $X_2$ has $E^\circ_{X_2/X^-} = +2.87\ V$. Is $X_2$ a good electron donor or electron acceptor?<br>
<details><summary><b>Answer</b></summary>
...
5. 🔴 Consider $E^\circ_{Sn^{4+}/Sn^{2+}} = +0.15\ V$ and $E^\circ_{Cr^{3+}/Cr} = -0.74\ V$. Which species is the most stable: $Sn^{4+}$, $Sn^{2+}$, $Cr^{3+}$, or $Cr$?<br>
<details><summary><b>Answer</b></summary>
...
**Q1. (NCERT Type)** 🟢 The standard electrode potential is measured by assigning a potential of zero to which electrode?<br>
...
**Q2. (Exemplar Type)** 🟡 Which of the following is an intensive property?<br>
...
**Q4. (Tricky)** 🔴 For the half-cell reaction $M^{n+} + ne^- \rightarrow M$, the Nernst equation shows how potential changes with concentration. If the concentration of $M^{n+}$ is zero, what happens to the electrode potential?<br>
(a) It becomes zero.
...
If you multiply the first reaction by 2 and the second by 3, what are the new standard oxidation potentials of A and B?<br>
...
- $E^\circ_{ox}<br>
(A) = -(-1.50\ V) = \textbf{+1.50\ V}$
- $E^\circ_{ox}<br>
(B) = -(+0.50\ V) = \textbf{-0.50\ V}$
</details>

**Q2.** 🔴 Consider a beaker containing a $1\ M$ solution of $ZnSO_4$ at 298 K. A piece of zinc is dropped into it. 
(a) Is this a standard half-cell?<br>
(b) Why doesn't a massive continuous current flow?<br>
(c) Does an electrical double layer form?<br>
...
**Q2.** 🟢 What is meant by Standard Electrode Potential?<br> *(1 mark)*
<details><summary><b>Model Answer</b></summary>
...
**Q3.** 🟡 Why is it impossible to measure the absolute electrode potential of a single half-cell?<br> *(2 marks)*
<details><summary><b>Model Answer</b></summary>
...
**Q1.** 🟡 ⭐ If the standard oxidation potential of $Zn/Zn^{2+}$ is $+0.76\ V$ and that of $Fe/Fe^{2+}$ is $+0.44\ V$, then which of the following is correct?<br>
...
**Q2.** 🔴 The standard reduction potentials for $Cu^{2+}/Cu$, $Zn^{2+}/Zn$, $Li^+/Li$, and $Ag^+/Ag$ are $+0.34\ V$, $-0.76\ V$, $-3.05\ V$, and $+0.80\ V$ respectively. Which of the following is the strongest oxidizing agent?<br>
(a) $Ag^+$
(b) $Li^+$
(c) $Cu^{2+}$
(d) $Zn^{2+}$
