# Chapter 5: Electrochemical Series — The Power Ranking of Elements

> *NCERT Sections 3.3.2*

---

## 🎯 Stage 1: The Core Idea

### The Universal Power Ranking
Imagine a corporate hierarchy or a strict power ranking list. The elements at the very top are the "CEOs" of reduction—they have immense power to pull electrons away from anyone below them. The elements at the very bottom are the ultimate "Generous Donors" (or weakest at pulling)—they happily give away their electrons to almost anyone above them.

This "ranking list" in chemistry is called the **Electrochemical Series (ECS)**. It is simply the arrangement of various elements and ions in order of their **Standard Reduction Potentials ($E^\circ$)**.

- **At the Top (e.g., $F_2$, $+2.87\ V$):** Highest tendency to gain electrons. They are the strongest **Oxidizing Agents**.
- **In the Middle ($H^+$, $0.00\ V$):** The "Sea Level" benchmark.
- **At the Bottom (e.g., $Li$, $-3.05\ V$):** Lowest tendency to gain electrons (highest tendency to lose them). They are the strongest **Reducing Agents**.

### The Golden Rule of Displacement
A substance placed *higher* in the series (higher $E^\circ$) will always act as the **Cathode (reduction)** and steal electrons from a substance placed *lower* in the series, forcing the lower substance to be the **Anode (oxidation)**.

---

## 🔬 Stage 2: The Formula Lab

The entire electrochemical series boils down to reading the $E^\circ$ values correctly.

| $E^\circ$ Value | Wants to undergo... | Acts as a... | Will displace... |
| :--- | :--- | :--- | :--- |
| **Highly Positive** | Reduction (Gain $e^-$) | Strong Oxidizing Agent | Metals below it from their salts (for non-metals) |
| **Highly Negative** | Oxidation (Lose $e^-$) | Strong Reducing Agent | Metals above it from their salts; $H_2$ from dilute acids |

**Mental Check:** 
- **Metals:** Lower $E^\circ_{red}$ displaces higher $E^\circ_{red}$ metal from its salt solution. (e.g., Zn displaces Cu).
- **Non-metals:** Higher $E^\circ_{red}$ displaces lower $E^\circ_{red}$ non-metal from its salt solution. (e.g., $Cl_2$ displaces $I_2$).

---

## 🧱 Stage 3: Type-wise Mastery

### Type 1: Identifying Strongest Oxidizing and Reducing Agents ⭐

**Pattern:** "Given a list of $E^\circ$ values, identify which species is the best oxidizing or reducing agent."
...
- **Strongest Oxidizing Agent:** Wants to gain electrons the most. Look for the most *positive* reduction potential. That is B ($+0.34\ V$). The ion **$B^{2+}$** is the strongest oxidizing agent.
</details>
...
3. 🟡 Arrange the following metals in increasing order of their reducing power: $Mg (-2.37\ V)$, $Cu (+0.34\ V)$, $Fe (-0.44\ V)$, $Ag (+0.80\ V)$.
<details><summary><b>Answer</b></summary>
Reducing power increases as $E^\circ$ becomes more negative. 
Most positive to most negative: $Ag < Cu < Fe < Mg$.
</details>

4. 🟡 Four halogens have the following $E^\circ$ values: $F_2 (+2.87\ V)$, $Cl_2 (+1.36\ V)$, $Br_2 (+1.09\ V)$, $I_2 (+0.54\ V)$. Arrange the halide ions ($F^-, Cl^-, Br^-, I^-$) in increasing order of reducing power.
<details><summary><b>Answer</b></summary>
A higher positive $E^\circ$ means the halogen strongly wants to reduce, making it a strong oxidizing agent. This means its corresponding halide ion *hates* oxidizing, making it a very weak reducing agent. 
So, reducing power of ions increases as $E^\circ$ becomes less positive.
Order: **$F^- < Cl^- < Br^- < I^-$**.
</details>
...
- Since $+0.74\ V > -0.15\ V$, **$Cr$ is a much better reducing agent than $Sn^{2+}$**.
</details>
...
<details><summary><b>Solution</b></summary>
- To check if a reaction occurs, see if the vessel (Fe) can displace the metal in the solution (Cu).
- Fe has a lower reduction potential ($-0.44\ V$) than Cu ($+0.34\ V$). 
- Metals with lower $E^\circ$ displace metals with higher $E^\circ$ from their solutions. 
- A spontaneous reaction will occur: $Fe + Cu^{2+} \rightarrow Fe^{2+} + Cu$.
- Therefore, **No, we cannot store it.** The iron vessel will dissolve and develop holes.
</details>
...
- Ag ($+0.80\ V$) > Fe ($-0.44\ V$) $\rightarrow$ Safe.
- Zn ($-0.76\ V$) < Fe ($-0.44\ V$) $\rightarrow$ Unsafe (Zn will dissolve).
Answer: **Cu and Ag containers**.
</details>
...
- This means the metal must have a **negative** standard reduction potential.
- Since Copper has a positive potential ($+0.34\ V$), it cannot displace hydrogen. 
- **No, Copper will not react.**
</details>
...
2. 🟢 Name two common coinage metals that will NOT dissolve in dilute, non-oxidizing acids like $HCl$.
<details><summary><b>Answer</b></summary>
...
### Type 4: Reaction Feasibility and Spontaneity ⭐

**Pattern:** "Using the Electrochemical Series to predict if a given hypothetical reaction will actually happen."

**Solved Example** 🟡
> Predict if the following reaction is feasible:
> $I_2(s) + 2Br^-(aq) \rightarrow 2I^-(aq) + Br_2(l)$
> Given: $E^\circ_{I_2/I^-} = +0.54\ V$, $E^\circ_{Br_2/Br^-} = +1.09\ V$.

<details><summary><b>Solution</b></summary>
- Look at the proposed reaction: $I_2$ is reducing to $I^-$. $Br^-$ is oxidizing to $Br_2$.
- For this to be spontaneous, Iodine must be a stronger oxidizing agent (higher $E^\circ$) than Bromine.
- Compare values: Iodine ($+0.54\ V$) < Bromine ($+1.09\ V$).
- Iodine is a *weaker* oxidizing agent than Bromine. It cannot force Bromide ions to oxidize.
- Therefore, the reaction is **not feasible** (non-spontaneous).
</details>
...
5. 🔴 Predict the feasibility: $2Fe^{3+} + 2I^- \rightarrow 2Fe^{2+} + I_2$. ($E^\circ_{Fe^{3+}/Fe^{2+}} = +0.77\ V$, $E^\circ_{I_2/I^-} = +0.54\ V$).
<details><summary><b>Answer</b></summary>
$Fe^{3+}$ is reducing in this equation. Since $E^\circ_{Fe}$ (+0.77 V) > $E^\circ_{I}$ (+0.54 V), $Fe^{3+}$ is a stronger oxidizing agent than $I_2$. It will successfully steal electrons from $I^-$. **Yes, it is feasible.**
</details>

---

### Type 5: Halogen Displacement Reactions ⭐
...
<details><summary><b>Solution</b></summary>
- To displace Bromine from $Br^-$, the reacting halogen must take electrons from $Br^-$ (i.e., it must oxidize $Br^-$ while it gets reduced).
- This means the reacting halogen must be a **stronger oxidizing agent** than Bromine.
- It must have a **higher standard reduction potential** than $Br_2$ ($+1.09\ V$).
- Both $F_2$ ($+2.87\ V$) and $Cl_2$ ($+1.36\ V$) have higher potentials.
- Answer: **$F_2$ and $Cl_2$**.
</details>
...
3. 🟡 Write the balanced chemical equation when Chlorine gas is passed through aqueous $NaBr$.
<details><summary><b>Answer</b></summary>
...
<details><summary><b>Solution</b></summary>
- The ion with the **highest reduction potential** is the most desperate to gain electrons. It will get reduced first with the least amount of electrical push.
- Highest $E^\circ$ is $Ag^+$ ($+0.80\ V$). It deposits first.
- Next is $Cu^{2+}$ ($+0.34\ V$). It deposits second.
- Lowest $E^\circ$ is $Zn^{2+}$ ($-0.76\ V$). It deposits last.
- Order of deposition: **Silver, then Copper, then Zinc**.
</details>
...
Reaction: $Cu^{2+} + H_2 \rightarrow Cu + 2H^+$.
**Copper metal will precipitate out** as hydrogen gas is bubbled through.
</details>
...
**Q1. (NCERT Type)** 🟢 Using the standard electrode potentials: 
$E^\circ(K^+/K) = -2.93\ V$
$E^\circ(Ag^+/Ag) = 0.80\ V$
$E^\circ(Hg^{2+}/Hg) = 0.79\ V$
...
<details><summary><b>Answer</b></summary>
**Answer: (a)**
Reducing power means tendency to lose electrons. Lower (more negative) $E^\circ$ means higher reducing power. 
Highest $E^\circ$ (Ag, +0.80) $\rightarrow$ Lowest reducing power.
Lowest $E^\circ$ (K, -2.93) $\rightarrow$ Highest reducing power.
...
(d) No, because Cu is a stronger reducing agent and will displace Ni.

<details><summary><b>Answer</b></summary>
**Answer: (c)**
Ni has a lower reduction potential, meaning it strongly prefers to oxidize compared to Cu. It will act as a reducing agent, reacting with the $Cu^{2+}$ ions. $Ni + Cu^{2+} \rightarrow Ni^{2+} + Cu$. The vessel will dissolve.
</details>

**Q3. (JEE Mains Type)** 🔴 Consider the following $E^\circ$ values:
$E^\circ_{Fe^{3+}/Fe^{2+}} = +0.77\ V$
$E^\circ_{Sn^{2+}/Sn} = -0.14\ V$
Under standard conditions, the potential for the reaction $Sn(s) + 2Fe^{3+}(aq) \rightarrow 2Fe^{2+}(aq) + Sn^{2+}(aq)$ is:
(a) $+0.91\ V$
(b) $+0.63\ V$
(c) $+1.68\ V$
(d) $+1.40\ V$
...
<details><summary><b>Answer</b></summary>
**Answer: (a)**
Identify Anode and Cathode from the reaction. Sn is oxidizing (Anode). $Fe^{3+}$ is reducing (Cathode).
$E^\circ_{cell} = E^\circ_{cathode} - E^\circ_{anode}$
$E^\circ_{cell} = 0.77\ V - (-0.14\ V) = 0.77 + 0.14 = \textbf{+0.91\ V}$.
...
(d) $Cu(s) + 2HCl(aq) \rightarrow CuCl_2(aq) + H_2(g)$

<details><summary><b>Answer</b></summary>
**Answer: (c)**
- (a) Cu ($+0.34$) cannot displace Zn ($-0.76$).
- (b) $Cl_2$ ($+1.36$) cannot displace F ($-2.87$ for oxidation). F is the strongest OA.
- (c) Zn ($-0.76$) easily displaces Ag ($+0.80$). This is highly favored.
- (d) Cu ($+0.34$) cannot displace H ($0.00$).
</details>
...
(b) Magnesium ($-2.37\ V$) is a stronger reducing agent than all three metals. It will displace them all. The metal with the highest reduction potential is the easiest to reduce and precipitates first. Sequence: **Copper first, then Iron, then Zinc**.
</details>
...
**Q4.** 🟢 Name the strongest oxidizing agent and strongest reducing agent in the periodic table based on $E^\circ$ values. *(1 mark)*
<details><summary><b>Model Answer</b></summary>
Strongest Oxidizing Agent: **Fluorine ($F_2$)**.
Strongest Reducing Agent: **Lithium metal ($Li$)**.
</details>
...
**Q1.** 🔴 ⭐ An aqueous solution containing $1\ M$ each of $Au^{3+}$, $Cu^{2+}$, $Ag^+$, and $Li^+$ is being electrolyzed by using inert electrodes. The value of standard reduction potentials are $Au^{3+}/Au = +1.50\ V$, $Cu^{2+}/Cu = +0.34\ V$, $Ag^+/Ag = +0.80\ V$, $Li^+/Li = -3.05\ V$. With increasing voltage, the sequence of deposition of metals on the cathode will be:
(a) $Li, Cu, Ag, Au$
(b) $Cu, Ag, Au$ (Li doesn't deposit)
(c) $Au, Ag, Cu, Li$
(d) $Au, Ag, Cu$ (Li doesn't deposit)

<details><summary><b>Answer</b></summary>
**Answer: (d)**
Metals deposit at the cathode via reduction. The higher the reduction potential, the easier it is to reduce. 
Highest is $Au$ (+1.50), then $Ag$ (+0.80), then $Cu$ (+0.34). They will deposit in that order: $Au, Ag, Cu$.
$Li^+$ (-3.05) has a much lower potential than Water (-0.83 V). So water will reduce to Hydrogen gas before Lithium ever deposits. Thus, $Li$ does not deposit at all from an aqueous solution.
</details>
...
(d) $O_2$ is produced in concentrated, $S_2O_8^{2-}$ is produced in dilute.

<details><summary><b>Answer</b></summary>
**Answer: (c)**
At the anode, oxidation happens. The reaction with the *lower* reduction potential (lower hurdle to reverse) happens first.
Water oxidizing to $O_2$ has a reverse potential of $-1.23\ V$.
Sulphate oxidizing to Persulphate ($S_2O_8^{2-}$) has a reverse potential of $-2.05\ V$.
Normally, water oxidizes first to yield $O_2$. However, if the solution is highly concentrated, the "overpotential" of oxygen formation increases, and the high concentration of sulphate ions makes the second reaction kinetically and thermodynamically favorable. Thus, $O_2$ in dilute, $S_2O_8^{2-}$ in concentrated.
</details>

---

*Next: [Chapter 6 — EMF of a Cell →](./06_emf_of_a_cell.md)*
