...
The problem? There are **six major ways** to express concentration, each designed for a different purpose. Knowing which one to use — and how they relate — is the core skill of this entire chapter.
...
**The Pattern:** You're given a situation. Which term applies?

#### Solved Example 2.1
**Q:** A chemist needs a concentration that won't change when the laboratory temperature shifts from 20°C to 30°C. Which term should they use? 🟢
...
#### Solved Example 2.2
**Q:** Which concentration term is most appropriate to describe the concentration of fluoride ions (0.0003%) in drinking water? 🟢
...
| # | Question | Difficulty |
|---|----------|------------|
| 2.1a | Why is molality preferred over molarity for colligative property calculations? | 🟢 |
| 2.1b | A solution is used in titrations. Which term gives the most direct equivalence relationship? | 🟢 |
| 2.1c | In the formula for Raoult's Law and Henry's Law, which concentration term appears? | 🟡 |
| 2.1d | A 37% HCl solution: this concentration is expressed as which term? | 🟢 |
| 2.1e | Which concentration term(s) are dimensionless? | 🟢 |
...
#### Solved Example 2.5
**Q:** A 1 M glucose solution is prepared at 25°C. When heated to 80°C, does the molarity change? Does molality change? 🟡
...
| 2.3b | A 2 M NaCl solution is cooled from 25°C to 5°C. Does concentration increase or decrease? Which term is it expressed in matters — explain. | 🟡 |
| 2.3c | For a colligative property calculation, why should molality be used instead of molarity? Give a concrete example. | 🔴 |
| DPP 3.8 | Which of the following concentration terms is temperature dependent? (A) % by mass (B) Mole fraction (C) Mass/volume ratio (D) Molality | 🟢 |
...
Given:
    ...
    V_solution = ? → W_solution = 36 + 200 = 236 g
...
| 2.4c | Why would molarity and molality for the same solution be equal only if density = 1 g/mL and solute molar mass is negligibly small? | 🔴 |
...
| 2.M2 | 100 mL of 0.1 M HCl is heated. Does the molarity change? What if you use molality? | T3 + conceptual | 🟡 |
...
| 2.M4 | Why is mole fraction used in Raoult's law? Why not molarity? | T1 + T3 | 🔴 |
...
| # | Question | Difficulty |
|---|----------|------------|
| 2.B1 | What is the SI unit of molality? Why is molality preferred for colligative property calculations? *(NCERT)* | 🟢 |
| 2.B2 | Which of the following are temperature-dependent: (a) mass percent, (b) molarity, (c) molality, (d) mole fraction? | 🟢 |
...
| 2.B5 | What is the difference between the denominator in Molarity and in Molality? Why does this matter for temperature dependence? | 🟡 |
...
**Q2.J1 🟡 ⭐**
Which of the following concentration terms does NOT change when the solution is heated?
(A) Molarity  (B) Normality  (C) Molality  (D) All change

**Q2.J2 🟡**
Mole fraction of water in a 1 molal aqueous NaCl solution is approximately:
(A) 0.018  (B) 0.982  (C) 1.0  (D) 0.5

**Q2.J3 🔴 ⭐**
A solution of H₂SO₄ is 18% by mass and has density 1.20 g/mL. The molarity of the solution is closest to:
(A) 1.8 M  (B) 2.2 M  (C) 2.4 M  (D) 3.6 M

**Q2.J4 🔴**
Which pair has the same units?
(A) Molarity and Normality  (B) Molality and Mole Fraction  (C) ppm and Mass percent  (D) All are dimensionless

**Q2.J5 🔴 ⭐**
The concentration of a solution is expressed as 500 ppm. What is the equivalent mass percent?
...
**2.J1 → Answer: (C)**
- Molarity (A) and Normality (B) both use volume in denominator → T-dependent.
...
- **Answer: (A)** Molarity and Normality have the same units (mol/L or eq/L)
...
| # | Question | Difficulty |
|---|----------|------------|
| 2.S1 | **Assertion (A):** The molarity of a $0.1\text{ M}$ aqueous solution of NaCl increases when it is heated from $25^\circ\text{C}$ to $50^\circ\text{C}$.<br>**Reason (R):** Heating causes the volume of the solution to expand. | 🟡 |
...
| 2.S3 | **Assertion (A):** For a very dilute aqueous solution, molarity and molality are almost numerically equal.<br>**Reason (R):** In highly dilute aqueous solutions, the density of the solution is approximately $1\text{ g/mL}$ and the mass of solute is negligible compared to the solvent. | 🟡 |
...
| 2.S5 | **Assertion (A):** A $10\% (\text{w/w})$ solution of $H_2SO_4$ in water is prepared. Its mole fraction of $H_2SO_4$ is independent of temperature.<br>**Reason (R):** Mole fraction is a ratio of moles, and the number of moles does not change upon heating. | 🟢 |
...
| 2.S7 | **Assertion (A):** The sum of mole fractions of all components in any solution is always equal to 1.<br>**Reason (R):** Mole fraction is a dimensionless quantity representing the part of a whole. | 🟢 |
...
| 2.S9 | **Assertion (A):** Molality is defined as the number of moles of solute dissolved per liter of solvent.<br>**Reason (R):** The density of water is exactly $1\text{ g/mL}$ at all temperatures, so $1\text{ L}$ of water is always $1\text{ kg}$. | 🔴 |
...
| 2.S11 | **Assertion (A):** If equal masses of two solutions (A and B) of the same solute are mixed, the final mass percent is simply the average of their individual mass percents.<br>**Reason (R):** Mass percent is an additive property when equal masses of solutions are combined. | 🟡 |
...
| 2.S13 | **Assertion (A):** Normality of a given acid solution can never be less than its molarity.<br>**Reason (R):** Normality is the product of molarity and the n-factor, and the n-factor for any substance is an integer $\ge 1$. | 🟡 |
...
| 2.S15 | **Assertion (A):** A $1\text{ m}$ solution of $NaCl$ is more concentrated than a $1\text{ M}$ solution of $NaCl$ at room temperature.<br>**Reason (R):** $1\text{ M}$ solution contains $1\text{ mole}$ in $1000\text{ mL}$ of solution, meaning the solvent volume is less than $1000\text{ mL}$, whereas $1\text{ m}$ contains $1\text{ mole}$ in $1000\text{ g}$ of solvent. | 🔴 |

<details>
<summary>💡 Detailed Explanations for Stage 7</summary>

**2.S1 → Answer: (D) A is false but R is true.**
...
**2.S3 → Answer: (A) Both A and R are true, and R is the correct explanation.**
...
**2.S5 → Answer: (A) Both A and R are true, and R is the correct explanation.**
...
**2.S7 → Answer: (A) Both A and R are true, and R is the correct explanation.**
...
**2.S9 → Answer: (D) A is false and R is false.** (Wait, actually both are false. Let me check the options. If both are false, standard A/R options sometimes don't cover it. I'll re-evaluate. The question says "Choose based on whether...". Ah, standard A/R usually has (D) as A is false but R is true. Wait, is R true? No, density of water is only exactly $1\text{ g/mL}$ at $4^\circ\text{C}$. It changes with T. So both are false. If standard options don't have "Both false", I will formulate it as: A is false but R is false. Let's just say both are false in explanation.)
...
**2.S11 → Answer: (A) Both A and R are true, and R is the correct explanation.**
...
**2.S13 → Answer: (A) Both A and R are true, and R is the correct explanation.**
...
**2.S15 → Answer: (A) Both A and R are true, and R is the correct explanation.**
...
- Therefore, Answer is (D) A is false but R is true. (Psychological trap: I almost fell for it myself!).
</details>
...
**Q2.M1 🟢**
You have $100\text{ g}$ of a $10\% (\text{w/w})$ $NaOH$ solution. How much water must you evaporate to make it a $20\% (\text{w/w})$ solution?
(A) $10\text{ g}$
(B) $20\text{ g}$
(C) $50\text{ g}$
(D) $80\text{ g}$
...
**Q2.M2 🟡 (The "Flip" Trap)**
The mole fraction of a solute in an aqueous solution is $0.2$. What is the ratio of moles of solute to moles of solvent?
(A) 1 : 5
(B) 1 : 4
(C) 4 : 1
(D) 1 : 0.8
...
**Q2.M3 🔴**
A student measures out exactly $1\text{ L}$ of a $1\text{ M}$ aqueous $NaCl$ solution at $25^\circ\text{C}$. The solution is then cooled to $4^\circ\text{C}$, causing the water to contract. Which of the following is TRUE about the solution at $4^\circ\text{C}$?
(A) Its molarity is exactly $1\text{ M}$.
(B) Its molarity is less than $1\text{ M}$.
(C) Its molarity is greater than $1\text{ M}$.
...
(C) $90\text{ g}$ of glucose in $1\text{ kg}$ of water.
(D) $180\text{ g}$ of glucose in $500\text{ g}$ of water.

**Q2.M5 🟡 (The "Density Missing" Trap)**
A solution is prepared by mixing $20\text{ mL}$ of ethanol with $80\text{ mL}$ of water. Assuming the final volume is $100\text{ mL}$, what is the mass percent of ethanol? (Density of ethanol = $0.789\text{ g/mL}$, Density of water = $1.0\text{ g/mL}$).
(A) $20\%$
(B) $16.5\%$
(C) $25\%$
(D) $19.7\%$
...
**Q2.M6 🔴**
An aqueous solution of urea has a mole fraction of urea equal to $0.1$. What is its molality? (Molar mass of water = $18\text{ g/mol}$).
(A) $5.55\text{ m}$
(B) $6.17\text{ m}$
(C) $10\text{ m}$
(D) $11.1\text{ m}$
...
**Q2.M7 🟡**
Which of the following will change if you take a solution from Earth to the Moon? (Assume closed container, constant temperature).
(A) Molarity
(B) Molality
(C) Mass percent
(D) None of the above
...
**Q2.M8 🟢**
A factory releases wastewater containing $0.05\text{ g}$ of lead per $1000\text{ kg}$ of water. What is the concentration of lead in ppm?
(A) $50\text{ ppm}$
(B) $5\text{ ppm}$
(C) $0.05\text{ ppm}$
(D) $0.5\text{ ppm}$
...
You have $1\text{ L}$ of a $2\text{ M}$ solution of $HCl$. You add $1\text{ L}$ of water. You then take $500\text{ mL}$ of this new mixture. What is the molarity of the $500\text{ mL}$ sample?
(A) $1\text{ M}$
(B) $0.5\text{ M}$
(C) $2\text{ M}$
(D) $0.25\text{ M}$
...
**Q2.M10 🟡**
A commercially available concentrated hydrochloric acid contains $38\% \text{HCl}$ by mass. What does this mean?
(A) $38\text{ g}$ of HCl in $100\text{ mL}$ of water.
(B) $38\text{ g}$ of HCl in $100\text{ mL}$ of solution.
(C) $38\text{ g}$ of HCl in $100\text{ g}$ of solution.
...
**Q2.M13 🟢**
Which term uses the exact same denominator as mole fraction?
(A) Molality
(B) Molarity
(C) Mass percent
(D) None of the above
...
$100\text{ mL}$ of $0.2\text{ M}$ $H_2SO_4$ is mixed with $100\text{ mL}$ of $0.2\text{ M}$ $NaOH$. What is the molarity of the resulting $Na_2SO_4$ salt in the final solution?
(A) $0.2\text{ M}$
(B) $0.1\text{ M}$
(C) $0.05\text{ M}$
(D) $0.4\text{ M}$
...
**Q2.M15 🟡**
For an extremely dilute aqueous solution, the numerical value of which two concentration terms will be almost perfectly identical?
...
- Trap: (A) 1:5, assuming 0.2 means 1 out of 5 parts is solute and the solvent is the remaining 5 parts (it's remaining 4 parts).
...
- Trap: (A) and (B) use "solution". (D) calculates $1\text{ mol}$ per $0.5\text{ kg}$, which is $2\text{ m}$.
...
- Trap: (A) $20\%$ is volume percent (v/v%), not mass percent (w/w%).
...
- Trap: (B) Halving it again because they took half a litre. Concentration is an intensive property!
...
- Trap: (D) $100\text{ g}$ of water. If it were $100\text{ g}$ of water, total mass would be $138\text{ g}$, so it wouldn't be $38\%$.
