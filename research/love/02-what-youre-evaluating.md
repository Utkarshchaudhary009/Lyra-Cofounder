...
> *Two dimensions matter: CHARACTER (who they are under pressure) and COMPATIBILITY (whether your lives can actually work together).*
...
The two real dimensions:

1. **Character** — Non-negotiable at any age. This is the foundation. Without it, nothing else holds.
2. **Compatibility** — Changes by life stage. This is the structural fit. Without it, even good character produces daily friction.

---

## 2.2 CHARACTER: The Non-Negotiables

Character is who they are when:
- No one is watching
- Things go wrong
- They have power over someone
- They're tired, stressed, and have nothing to gain from being good

**Character does not improve with your love.** People with bad character who are dating you simply have motivation to perform. Remove the motivation (comfort, familiarity, marriage lock-in) and the performance drops. What's underneath is what you get.
...
Character doesn't reveal itself in a weekend or even a month. You need to see someone cycle through:
...
## 2.3 COMPATIBILITY: The Friction Generators

Compatibility is not about matching interests. Two people who both like hiking but disagree on money will have a worse partnership than two people with different hobbies who agree on finances.

**Compatibility is about alignment on the things that produce daily friction if misaligned.**

### The Five Friction Generators
...
How each person handles disagreement:
- Fighter vs. avoider
- Processor (needs to talk through everything) vs. reactor (responds in the moment)
...
#### 5. Intimacy and Connection Needs
...
## 2.4 The Interaction Between Character and Compatibility

**Good character + poor compatibility = A good person who isn't right for you.** Respect them, wish them well, but don't force it. Not every good human is YOUR good human.

**Poor character + good compatibility = A dangerous illusion.** Everything fits on paper but the foundation is rotten. This is the person who checks every box but lies to your face, or matches your lifestyle perfectly but can't take accountability.

**Good character + good compatibility = The viable foundation.** Not perfection — viability. Something worth building on. Something that can weather storms.

**Poor character + poor compatibility = Walk away immediately.** Nothing to discuss.

---

## Chapter Summary

- Evaluate on TWO dimensions: Character (non-negotiable) and Compatibility (negotiable but critical)
- Character is observed through behavior over time, not stated intentions
- 90-day minimum before drawing character conclusions
- Compatibility is about the 5 friction generators: Money, Conflict Style, Life Trajectory, Family, Intimacy
- Good character without compatibility = wrong match. Compatibility without character = dangerous match.

---

[← Previous: Destroying the Assumptions](./01-destroying-the-assumptions.md) | [Back to Index](./INDEX.md) | [Next: The Dopamine Reality →](./03-the-dopamine-reality.md)
