...
> *Not "gotcha" games. Not tricks. Honest observation over time. These tests don't manipulate — they reveal what's already there.*

---

## How to Use These Tests

- **Don't stage scenarios.** Manufactured tests produce manufactured responses. Life will generate every one of these situations naturally. Your job is to OBSERVE when they happen.
- **Track patterns, not incidents.** Anyone can fail a test once (bad day, personal crisis, exhaustion). Track behavior over **10+ instances** before drawing conclusions.
- **Apply them to yourself too.** Every test you run on them, run on yourself. This isn't a one-directional evaluation — it's mutual.

---

## Test 1: THE STRESS TEST

**What it measures:** Who they are when the performance stops.
...
**Unhealthy:** Treating you like an emotional punching bag and later saying "I was just stressed" as if that's a valid excuse for cruelty.

---

## Test 2: THE POWER TEST

**What it measures:** Their character when there are no consequences for bad behavior.
...
**What it measures:** Their relationship with delayed gratification, honesty, and shared resources.
...
**The subtle version:** Watch how they tip. How they respond to unexpected expenses. Whether they nickel-and-dime in shared situations or default to generosity.

---

## Test 4: THE CONFLICT TEST

**What it measures:** Whether conflict builds the relationship or erodes it.
...
|----------------|-------------------|
| Brings up past ammunition | Stays on the current issue |
| Uses your vulnerabilities against you | Protects your vulnerabilities even in anger |
| Needs to be RIGHT | Needs to UNDERSTAND |
| Raises voice, attacks character | Addresses behavior, not identity |
...
**Consistent distance after conflict = fundamental incompatibility in conflict style.** This doesn't improve with time unless both people actively learn new patterns.

---

## Test 5: THE GROWTH TEST

**What it measures:** Whether they're still becoming or have stopped.
...
**The positive version:** A person committed to growth will stumble, fail, and regress — but they'll keep trying. That's the signal. Not perfection. Persistent effort.

---

## Test 6: THE FAMILY OBSERVATION TEST

**What it measures:** The programming they inherited and whether they're aware of it.
...
**The hopeful note:** Someone who is AWARE of their family's unhealthy patterns and actively working against them is showing you character in real time. That awareness IS the growth.

---

## Test 7: THE SOLITUDE TEST

**What it measures:** Whether they're a whole person or a half looking for completion.
...
## Test 8: THE TIME TEST

**What it measures:** Whether the choice survives beyond chemical assistance.
...
**Real choosing begins when:**
- The butterflies settle
- They've seen you at your worst (sick, stressed, failing, ordinary)
- You've seen them at their worst
- The relationship has had genuine conflict
...
## Test 9: THE SUCCESS TEST

**What it measures:** Their security or insecurity — revealed under YOUR light.
...
An insecure partner will eventually sabotage you or resent you. Not always consciously — but the corrosion is constant.

**The deepest version:** Watch what happens when you succeed at something THEY failed at, or in a domain THEY care about. If they can genuinely celebrate that — that's rare, precious character.

---

## Test 10: THE ACCOUNTABILITY TEST

**What it measures:** Emotional maturity at its core.
...
| Level | Example | What It Signals |
|-------|---------|----------------|
| **No accountability** | "That didn't happen" / "You're overreacting" | Gaslighting — run |
| **Deflected accountability** | "I was wrong BUT you made me do it" | They understand the concept but can't execute it |
| **Minimized accountability** | "I guess I was wrong, whatever" | They resent being accountable |
| **Conditional accountability** | "I was wrong, but only because you did X first" | Progress but still protecting ego |
| **Clean accountability** | "I was wrong. I understand why that hurt you. Here's what I'll do differently." | Emotional maturity. Rare. Valuable. |
...
[← Previous: Ages & Stages](./04-ages-and-stages.md) | [Back to Index](./INDEX.md) | [Next: The Conflict-Repair Test →](./06-the-conflict-repair-test.md)
